...
// function to provide a speed for the motors 
void provideSpeed(int speed )
{
  analogWrite(LPWM_MOTORRIGHT_PIN,speed);
  analogWrite(RPWM_MOTORRIGHT_PIN,0);
  analogWrite(LPWM_MOTORLEFT_PIN,speed);
  analogWrite(RPWM_MOTORLEFT_PIN,0);
...
void stopMotorRight()
{
  analogWrite(RPWM_MOTORRIGHT_PIN,0); // motor1a
  analogWrite(LPWM_MOTORRIGHT_PIN,0);  // motor1
